...
import svgBox from "../../assets/svg/icons8-box.svg";
        ...
        <div className="container">
          <div className="row justify-content-center align-items-center">
            ...
            <Fade right duration={700}>
              <p className="ml-auto">
                <span>Terms</span> <span className="font-weigth-bold">&</span>{" "}
                Conditon
              </p>
              <img src={svgBox} alt="logoSvg" />
            </Fade>
          </div>
          <div className="row mt-5">
            ...
            <p>Welcome to Whatnime!</p>

            <p>
              These terms and conditions outline the rules and regulations for
              the use of Whatnime's Website, located at www.whatnime.com.
            </p>

            <p>
              By accessing this website we assume you accept these terms and
              conditions. Do not continue to use Whatnime if you do not agree to
            ...
            <p>
              We employ the use of cookies. By accessing Whatnime, you agreed to
              use cookies in agreement with the Whatnime's Privacy Policy.
            </p>
            ...
            <p>
              Unless otherwise stated, Whatnime and/or its licensors own the
              intellectual property rights for all material on Whatnime. All
              intellectual property rights are reserved. You may access this
              from Whatnime for your own personal use subjected to restrictions
              set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul>
              <li>Republish material from Whatnime</li>
              <li>Sell, rent or sub-license material from Whatnime</li>
              <li>Reproduce, duplicate or copy material from Whatnime</li>
              <li>Redistribute content from Whatnime</li>
            </ul>
            ...
            <p>
              ...
              Whatnime does not filter, edit, publish or review Comments prior
              to their presence on the website. Comments do not reflect the
              views and opinions of Whatnime,its agents and/or affiliates.
              ...
              laws, Whatnime shall not be liable for the Comments or for any
            ...
            <p>
              Whatnime reserves the right to monitor all Comments and to remove
            ...
            <p>
              You hereby grant Whatnime a non-exclusive license to use,
            ...
            <p>
              ...
              Whatnime; and (d) the link is in the context of general resource
              information.
            </p>
            ...
            <p>
              ...
              by sending an e-mail to Whatnime. Please include your name, your
            ...
            <p>
              No use of Whatnime's logo or other artwork will be allowed for
